...
//        }
    ...
    @UnexpectedResponseExceptionDetail(exceptionTypeName = "RESOURCE_MODIFIED", statusCode = { 409 })
    @UnexpectedResponseExceptionDetail
    Boolean isBoolean(@HostParam("endpoint") String endpoint, @PathParam("itemId") long itemId,
                                        @HeaderParam("accept") String accept, @BodyParam("application/json") BinaryData contents,
                                        RequestOptions requestOptions);
    ...
    @UnexpectedResponseExceptionDetail(exceptionTypeName = "RESOURCE_MODIFIED", statusCode = { 409 })
    @UnexpectedResponseExceptionDetail
    byte[] isBytes(@HostParam("endpoint") String endpoint, @PathParam("itemId") long itemId,
                      @HeaderParam("accept") String accept, @BodyParam("application/json") BinaryData contents,
                      RequestOptions requestOptions);
    ...
    Response<Void> testMethod(@HostParam("endpoint") String endpoint, @PathParam("itemId") long itemId,
            @HeaderParam("accept") String accept, @BodyParam("application/octet-stream") ByteBuffer request,
